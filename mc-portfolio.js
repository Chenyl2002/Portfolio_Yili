...
(function () {
  ...
  var EXPERIENCES = {
    "bytedance-intern": {
      title: "字节跳动 · 江南工作室 - 关卡策划",
      period: "2026.07 - 至今",
      summary: "参与字节跳动江南工作室旗下三体IP的3A级PVE射击游戏研发，负责玩法、怪物系统与关卡的设计与落地。",
      tags: ["关卡策划","Unity","Tai编辑器","怪物系统","PVE"],
      work: [
        "设计2套附加玩法（对标《流放之路》裂隙/小精灵机制），完成从策划案、三方评审到开发排期与落地的全流程",
        "负责怪物通用技能的设计与配置，以及怪物通用技能系统的迭代与迁移",
        "使用Unity负责刷怪关卡副本从资产梳理、关卡白盒搭建到玩法配置的策划闭环，完成5个关卡板块",
        "跨团队协作美术/特效/程序，推进怪物特效产出，优化技能编辑配置与Tai关卡编辑器性能"
      ],
      outcome: [
        "完成12个怪物技能的设计与配置，以及怪物通用技能系统的迭代与迁移",
        "2套附加玩法均进入开发阶段，进行落地制作和配置",
        "设计完成5个副本区域的关卡搭建以及特效配置"
      ]
    },
    "tju-adri-intern": {
      title: "天津大学建筑设计研究院 - 设计师助理",
      period: "2025.06 - 2025.08",
      summary: "参与天津海运职业学院体育场改造与天津市第九中学外立面翻新项目，负责方案设计、现场勘测与图纸产出。",
      tags: ["方案设计","CAD","SketchUp","Photoshop","现场勘测"],
      work: [
        "负责天津海运职业学院体育场改造项目看台与操场部分方案设计，通过优化布局提升15%观赛容量，并选用环保材料增强场地安全性",
        "参与天津市第九中学外立面翻新项目，完成现场勘测与色彩规划工作",
        "设计协助：配合主创设计师完成方案设计、施工图绘制及效果图调整，使用CAD、SU、PS等软件制作图纸和模型，确保符合规范",
        "技术支持：整理项目资料，如规范、案例、技术数据，辅助设计决策，协助制作汇报文本、PPT及展板",
        "团队沟通：与主创设计师及同组同事保持高频沟通，准确接收设计需求、同步方案进度"
      ],
      outcome: [
        "体育场看台与操场方案通过布局优化提升15%观赛容量",
        "完成第九中学外立面现场勘测与色彩规划方案",
        "独立产出多套施工图、效果图与汇报展板物料"
      ]
    },
    "xingyue-camp": {
